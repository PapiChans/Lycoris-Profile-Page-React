        ...
        <div className='flex h-full w-6/12 sm:w-8/12 items-center px-8'>
            ...
            <div className='hidden md:block h-full w-full'>
              ...
              {menuItems.map((item, idx) => (
                <li onClick={() => handleswitch(item)} key={idx} className="h-full w-20 flex items-center justify-center cursor-pointer relative group transition-all ease-in-out duration-300 bg-transparent">
